...
def pintaMike1():
    ...
    pintaCejasMike(0.5, 1.9, 11.9, 0.1, 1)
    pintaCejasMike(-1.5, 1.9, 11.9, 0.1, 1)
    pintaBocaSorpresaMike(0, 1.9, 10.5, 0.3, 15, 30)
...
def pintaMike2():
    ...
    pintaCejasMike(0.5, 1.9, 11.9, 0.1, 1)
    pintaCejasMike(-1.5, 1.9, 11.9, 0.1, 1)
    pintarSonrisaMike(0, 2, 11, ancho=1.5, altura=1.5, resolucion=50)
    pintaCilindroMike(1, 0, 0.5, 0.3, 2.5)
    pintaCilindroMike(-1, 0, 0.5, 0.3, 2.5)
    pintaZapatosMike(1, 0, 0, 0.6, 1)
    pintaZapatosMike(-1, 0, 0, 0.6, 1)
...
def pintaMike3():
    ...
    glRotatef(-90, 1, 0, 0)
    glRotatef(180, 0, 0, 1)
    pintaCejasenojado1Mike(0.5, 2, 11.9, 0.1, 1)
    pintaCejasenojado2Mike(-.5, 2, 11.9, 0.1, 1)
    pintaCejasMike(-.5, 2, 10.7, 0.1, 1)
    pintaCilindroMike(1, 0, 0.5, 0.3, 2.5)
    pintaCilindroMike(-1, 0, 0.5, 0.3, 2.5)
    pintaZapatosMike(1, 0, 0, 0.6, 1)
...
def pintaMike4():
    ...
    pintaCejasMike(-1.5, 1.9, 11.9, 0.1, 1)
    pintaCejasMike(-.5, 2, 10.7, 0.1, 1)
    pintaCejasMike(0.7, 2, 11.5, 0.1, .5)
    pintaCilindroMike(1, 0, 0.5, 0.3, 2.5)
    pintaCilindroMike(-1, 0, 0.5, 0.3, 2.5)
    pintaZapatosMike(1, 0, 0, 0.6, 1)
    pintaZapatosMike(-1, 0, 0, 0.6, 1)
...
def pintaMike5():
    ...
    glRotatef(-90, 1, 0, 0)
    glRotatef(180, 0, 0, 1)
    pintaCejasenojado2Mike(1.5, 2.3, 11.9, 0.1, 1)
    pintaCejasenojado1Mike(-1.5, 1.9, 11.9, 0.1, 1)
    pintaBocaSorpresaMike(0, 1.9, 10.5, 0.3, 15, 30)
    pintaCilindroMike(1, 0, 0.5, 0.3, 2.5)
    pintaCilindroMike(-1, 0, 0.5, 0.3, 2.5)
    pintaZapatosMike(1, 0, 0, 0.6, 1)
